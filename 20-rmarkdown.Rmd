...
![markdown tutor 1](images/korea_night.png)
...
![table rmarkdown](images/table_mrdown.png)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/wzb0sOobTkk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>



### other language and inline
...
```
 ...
 iris 데이터는 총 `r nrow(iris)` 줄이며, 항목은 `r colnames(iris)` 입니다. 
...
dd
```
  보시다시피, `r dd$Species` 의 평균은 각각 `r dd$avg` 입니다. 
