...
<iframe width="560" height="315" src="https://www.youtube.com/embed/dg6URREi9as" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![방화벽 포트](img/gcpfirewall2.png)

같은 방법으로 3838 포트도 열어 줍니다. (3838은 shinyserver의 기본 포트가 될 것 입니다.)

![firewall outcome](img/gcp_fw.png)
...
**참고 동영상**
<iframe width="560" height="315" src="https://www.youtube.com/embed/U2QqhCd5tRg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/0hBQ-x7aPXE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> shiny server index.html 수정

**참고 동영상**
<iframe width="560" height="315" src="https://www.youtube.com/embed/J5K05KPumeQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
```
이후 `a` 치고, editor 수정 나올때는 `esc`누루고 `:wq!`. 그냥 저장하지 않고 나오고 싶으면 `:qa!` 로 나오기.

shiny-server 로가서 새로 고침. 

![shiny-server index](img/shiny_index1.png)
